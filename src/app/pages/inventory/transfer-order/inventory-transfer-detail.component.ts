...
@Component({
  ...
  template: `
    <h1 class="title-1">
      Transfer Inventory Order {{entity.href|entityToSlug}}
    </h1>
    <p style="margin-bottom: 24px;">Skip this step if you don't want to change anything.</p>
  ...
  styles: [
    ...
    '.general-table-product td{height: 56px; word-break: break-word;}',
...
export class InventoryTransferDetailComponent extends AbstractDetailComponent<ITransferOrder> implements OnInit {
