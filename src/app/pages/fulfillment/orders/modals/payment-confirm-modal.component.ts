    ...
    <ngx-smart-modal [identifier]="'orderPaymentConfirm'" #modal [customClass]="'no-close-icon-modal no-padding-modal'">
      <div class="wrapper">
        <div class="message">
          ...
          <p class="body-2">Make sure payment information matches the amount received onthe designated bank account. If there's a mismatch, please contact the customer.</p>
        </div>
        <div class="action">
