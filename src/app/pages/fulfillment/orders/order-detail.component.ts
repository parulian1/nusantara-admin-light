...
import {DialogResult, ErrorResult, getSlugFromHref, ToastLevelEnum, ToastService} from '@nusantara/core';
import {OrderService, ShipmentService} from '@nusantara/services';
import {drf, IOrderChildrenData, order, OrderStatusType} from '@nusantara/models';
import {
...
export class OrderDetailComponent implements OnInit, AfterViewInit {
  ...
  manualShipment(iOrderChildrenDatum: IOrderChildrenData) {
    this.inputAwb.open();
    this.inputAwb.orderNumber.setValue(getSlugFromHref(iOrderChildrenDatum.href));
  }
