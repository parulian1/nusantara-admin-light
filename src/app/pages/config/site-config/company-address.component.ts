...
export class CompanyAddressComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service
      ...
      .subscribe(data => {
        ...
        this.adaptToInner(this.form.value as ICompanyAddress);
      });
    ...
    this.innerForm.valueChanges.subscribe((companyAddress) => {
      if (!this.isInitializing) {
        this.adaptToOuter(companyAddress);
      }
    });
  }
   ...
   */
  private adaptToInner(outerValue: ICompanyAddress) {
